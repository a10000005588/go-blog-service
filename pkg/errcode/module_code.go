...
var (
	...
	ErrorCreateTagFail  = NewError(20010002, "創建標籤列表失敗")
	ErrorUpdateTagFail  = NewError(20010003, "更新標籤列表失敗")
	ErrorDeleteTagFail  = NewError(20010004, "刪除標籤列表失敗")
	ErrorCountTagFail   = NewError(20010005, "統計標籤失敗")

	ErrorGetArticleFail    = NewError(20020001, "獲取單一文章失敗")
