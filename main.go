...
// @title 部落格後端系統
// @version 1.1
// @description 可進行新增修改刪除文章&標籤的簡單後端系統，搭配MYSQL資料庫儲存，
// @description 基於『再強一點，用Go語言完成6個大型專案』本書所提供的範例程式碼，其程式碼來自於 『Go 语言编程之旅：一起用 Go 做项目』
func main() {
...
func setupFlag() error {
	...
	flag.StringVar(&config, "config", "configs/", "指定要使用的配置文件路徑")
	flag.BoolVar(&isVersion, "version", false, "編譯信息")
	flag.Parse()
